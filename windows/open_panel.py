...
class opening_panel(object):
	...
	def open_panel(self):
		...
		#labels added
		lab5 = tk.Label(self.window,text="",bg="turquoise", fg="dark slate gray",font = ("times" , 36, 'bold'))
		lab1 = tk.Label(self.window,text="Face Mask Detection",bg="turquoise", fg="dark slate gray",font = ("times" , 36, 'bold'))
		lab2 = tk.Label(self.window,text="&",bg="turquoise", fg="dark slate gray",font = ("times" , 36, 'bold'))
		lab3 = tk.Label(self.window,text="Attendance System",bg="turquoise", fg="dark slate gray",font = ("times" , 36, 'bold'))
		lab4 = tk.Label(self.window,text="",bg="turquoise", fg="dark slate gray",font = ("times" , 36, 'bold'))
