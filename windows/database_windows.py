...
class database_methods(object):
    ...
    def add_window(self):
        ...
        lab01 = tk.Label(self.window_add, text="", bg="turquoise", fg="dark slate gray", font=("times", 30, 'bold'))
        lab02 = tk.Label(self.window_add, text="Add User", bg="turquoise", fg="dark slate gray", font=("times", 30, 'bold'))
        lab03 = tk.Label(self.window_add, text="", bg="turquoise", fg="dark slate gray", font=("times", 30, 'bold'))

        self.lbl_id1 = tk.Label(self.window_add,text="Name: ", font=("times", 10, 'bold'),bg="turquoise", fg="Black",height=2,width=20,)
        self.entry_id1 = tk.Entry(self.window_add, width=45,)

        self.lbl_id2 = tk.Label(self.window_add,text="Year: ", font=("times", 10, 'bold'),bg="turquoise", fg="Black",height=2,width=20,)
        self.entry_id2 = tk.Entry(self.window_add, width=45,)

        self.lbl_id3 = tk.Label(self.window_add,text="Department: ", font=("times", 10, 'bold'),bg="turquoise", fg="Black",height=2,width=20,)
        self.entry_id3 = tk.Entry(self.window_add, width=45,)

        lab04 = tk.Label(self.window_add, text="", bg="turquoise", fg="dark slate gray", font=("times", 30, 'bold'))
        self.btn_add = tk.Button(self.window_add,text="Add Student",font=("times", 10, 'bold'),bg="old lace",height=3,width=42,command=self.window_add)
