...
class admin_panel(object):
	...
	def admin(self):
		...
		lab20 = tk.Label(self.admin_window,text="",bg="turquoise", fg="dark slate gray",font = ("times" , 15, 'bold'))
		lab21 = tk.Label(self.admin_window,text="Select an option",bg="turquoise", fg="dark slate gray",font = ("Simplified Arabic fixed" , 15, 'bold'))
		lab22 = tk.Label(self.admin_window,text="",bg="turquoise", fg="dark slate gray",font = ("times" , 20, 'bold'))
